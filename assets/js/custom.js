...
jQuery(function($){
	...
	jQuery(".main-nav a").click(function(event){
		...
		//
		//This is the scenario where we don't want to jump to an anchor on the
		//page so just return so the defaul click is handled.
		if (this.className == "opennewpage") return;
